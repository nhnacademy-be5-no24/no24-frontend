...
public class ElasticServiceImpl implements ElasticService {
     ...
     */
    @Override
    public Page<ElasticResponseDto> searchAll(String keyword, Long categoryId, int pageSize, int offset) {
        Pageable pageable = PageRequest.of(pageSize, offset);
        Page<ElasticDocument> searchBooks = elasticRepository.findAll(keyword, categoryId, pageable);
